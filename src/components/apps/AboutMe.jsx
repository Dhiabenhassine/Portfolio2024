          ...
          <main className="border-0 flex w-full  justify-center opacity-75 mt-0 text-sm">
             ...
             <li>
              ...
              <div className="timeline-start md:text-end mb-1">
                <time className="font-mono text-lg italic">
                  {workExperienceTemplate[0].company}
                </time>
                
                <div className="text-xl font-bold font-3xl">
                  {workExperienceTemplate[0].designation}
                </div>
                {workExperienceTemplate[0].duration}
              </div>
            ...
            <li>
              ...
              <div className="timeline-end mb-1">
                <time className="font-mono text-lg italic">
                {workExperienceTemplate[1].company}
                </time>
              
                <div className="text-xl font-bold font-3xl">
                  {workExperienceTemplate[1].designation}
                </div>
                {workExperienceTemplate[1].duration}
              </div>
              <hr className="bg-gray-500" />
            </li>
            <li>
            ...
            <li>
              ...
              <div className="timeline-end mb-3">
                <time className="font-mono text-lg italic">
                {workExperienceTemplate[3].company}
                </time>
